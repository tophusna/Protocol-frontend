...
export default function DialogClaimPeko({ userInfo, visible, setVisible }: IProps) {
  ...
  return (
    <CustomDialog title="Claim PIL Token" visible={visible} setVisible={setVisible}>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between">
          <p className="text-gray-500">Max: {maxAmount.toFixed(4)} <span className="uppercase">PIL</span></p>
